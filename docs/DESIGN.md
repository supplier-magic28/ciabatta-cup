...
| 07 Manage tournament | `/admin/tournaments/new`, `/admin/tournaments/[tournamentId]` | Partial | Four-player setup, participant replacement, deterministic fixtures, irreversible draw locking, locked-in/game-day email actions, reviewed result entry, decider planning, finals, completion, and stable pending states are live. Knockout preview and mid-event roster changes are deferred. |
