  ...
  return <main className={styles.viewer}>
    ...
    <div className={styles.layout}>
      ...
      <aside className={styles.story}>
        <p className={styles.eyebrow}>The physical cup</p><h2>Engraved through every reign</h2>
        <p className={styles.intro}>This collectible returns under the same trophy key. Each completed win adds another line to its derived history.</p>
